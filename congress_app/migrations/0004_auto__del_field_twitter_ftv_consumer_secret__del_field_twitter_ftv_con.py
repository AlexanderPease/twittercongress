...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Twitter_FTV.access_key'
        db.add_column(u'congress_app_twitter_ftv', 'access_key',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Twitter_FTV.access_secret'
        db.add_column(u'congress_app_twitter_ftv', 'access_secret',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Twitter_FTV.access_key'
        db.delete_column(u'congress_app_twitter_ftv', 'access_key')

        # Deleting field 'Twitter_FTV.access_secret'
        db.delete_column(u'congress_app_twitter_ftv', 'access_secret')
