...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Twitter_FTV.email'
        db.add_column(u'congress_app_twitter_ftv', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Twitter_FTV.email_password'
        db.add_column(u'congress_app_twitter_ftv', 'email_password',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Twitter_FTV.email'
        db.delete_column(u'congress_app_twitter_ftv', 'email')

        # Deleting field 'Twitter_FTV.email_password'
        db.delete_column(u'congress_app_twitter_ftv', 'email_password')
    ...
    models = {
        ...
        u'congress_app.twitter_ftv': {
            ...
            'email_password': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'handle': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'politician': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['congress_app.Politician']", 'unique': 'True'}),
            'user_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
